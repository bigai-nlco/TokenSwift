#!/bin/bash
#SBATCH --job-name=qwen_32b  # create a short name for your job
...
torchrun  --master-port 2222 --nproc_per_node=2 main.py \
    --target Qwen2.5-32B \
    --model_type qwen2_5 \
    --ckpt_path /mnt/buffer/wutong/adapter_ckpts_qwen2_5_32b/kv_lr_0.005/checkpoint-200 \
    --prefill_len 4096 \
